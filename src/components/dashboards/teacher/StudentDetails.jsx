...
import { ArrowBack, BlockOutlined, Clear, Print } from '@mui/icons-material'
...
export default function StudentDetails({windowSize}) {
  ...
  return (
    <Body>
        ...
        <Button variant="primary" startIcon={<ArrowBack/>} sx={{'alignSelf':'start'}} onClick={()=> navigate('/teacher/students/all')}>العودة</Button>
        <Container>
          <ProfileHeader>
        ...
        <Container>
          ...
          <SubContainer>
            ...
            <ProfileDatas  width={windowSize.width}>
              ...
              <Typography variant="p" sx={{'whiteSpace':'normal', color: UISettings.colors.darkIcons,direction:'ltr'}}>ذكر</Typography>
            </ProfileDatas>
          </SubContainer>
        </Container>
        ...
        <Container>
          <ProfileHeader  style={{marginBottom: '15px'}}>
            <img src={'../../../../src/assets/titleStar.svg'} alt="academy_logo" width={40} style={{margin: '0px 0px'}} />
            <ProfileInfos>
                <Typography variant="h6" sx={{'fontFamily':'Cairo','fontWeight':600,'textWrap':'wrap','direction':'rtl'}}>معلومات الدراسة</Typography>
            </ProfileInfos>
          </ProfileHeader>
          <SubContainer>
            <ProfileDatas  width={windowSize.width}>
              <Typography variant="p" sx={{'fontFamily':'Cairo','fontWeight':600,'textWrap':'wrap','direction':'rtl', marginBottom: "5px"}}>التخصص</Typography>
              <Typography variant="p" sx={{'whiteSpace':'normal', color: UISettings.colors.darkIcons}}>علوم الحاسوب</Typography>
            </ProfileDatas>
            <ProfileDatas  width={windowSize.width}>
              <Typography variant="p" sx={{'fontFamily':'Cairo','fontWeight':600,'textWrap':'wrap','direction':'rtl', marginBottom: "5px"}}>المهنة</Typography>
              <Typography variant="p" sx={{'whiteSpace':'normal', color: UISettings.colors.darkIcons}}>مهندس برمجيات</Typography>
            </ProfileDatas>
            <ProfileDatas  width={windowSize.width}>
            ...
            <ProfileDatas  width={windowSize.width}>
              <Typography variant="p" sx={{'fontFamily':'Cairo','fontWeight':600,'textWrap':'wrap','direction':'rtl', marginBottom: "5px"}}>إسم المدرسة / الجامعة</Typography>
              <Typography variant="p" sx={{'whiteSpace':'normal', color: UISettings.colors.darkIcons}}>جامعة محمد بوقرة</Typography>
            </ProfileDatas>
            <ProfileDatas  width={windowSize.width}>
              ...
              <Typography variant="p" sx={{'whiteSpace':'normal', color: UISettings.colors.darkIcons}}> 20 حزب </Typography>
            </ProfileDatas>
          </SubContainer>
        </Container>
